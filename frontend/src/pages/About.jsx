  ...
  <span>
    ...
    />
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            This is your chance to turn your tech ideas into real-world businesses!
          </p>
          <p 
            className="mb-10 text-lg"
            style={{ animation: 'fade-in-up 1s 0.9s both' }}
          >
            Welcome to Tech Tank, the ultimate fusion of technology, business, and entrepreneurship! 
            This is not just another hackathon—it's a startup battlefield where coders, innovators, 
      ...
      <main>
        ...
        <section 
          ...
          className={`py-20 px-4 ${isVisible['who-can-participate'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-1000 ease-out`}
        >
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-[#E4CD15]/10 p-6 rounded-lg border-l-4 border-[#E4CD15] transform transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-[#E4CD15]/20">
                <h3 className="text-xl font-bold mb-4 text-[#38AAC9]">The Innovators</h3>
                <p>Developers who dream big and build bigger.</p>
              </div>
              
              <div className="bg-[#E4CD15]/10 p-6 rounded-lg border-l-4 border-[#E4CD15] transform transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-[#E4CD15]/20">
                <h3 className="text-xl font-bold mb-4 text-[#38AAC9]">The Strategists</h3>
                <p>Business minds who can turn tech into profit.</p>
              </div>
              
              <div className="bg-[#E4CD15]/10 p-6 rounded-lg border-l-4 border-[#E4CD15] transform transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-[#E4CD15]/20">
                <h3 className="text-xl font-bold mb-4 text-[#38AAC9]">The Pitch Masters</h3>
            ...
            <div className="mt-12 p-6 bg-[#38AAC9]/10 border-l-4 border-[#38AAC9] rounded-r-lg">
              <p className="text-lg">Tech Tank is where tech meets entrepreneurship. This is your chance to create, compete, and captivate investors!</p>
            </div>
          </div>
        </section>
        ...
        <section 
          ...
          className={`py-20 px-4 ${isVisible['about'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-1000 ease-out`}
        >
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-lg mb-6">
              Tech Tank is a Shark Tank-inspired hackathon conducted by ACM RVCE Student Chapter 
              and GDG (Google Developer Groups) RVCE. In today's tech-driven world, it's not just 
              about building great products—it's about making them market-ready.
            </p>
            
            <p className="text-lg">
              This event bridges the gap between technology and business by encouraging participants 
              to develop scalable, investor-ready B2B and B2C solutions. Compete, innovate, and pitch 
              your way to success!
            </p>
          </div>
        </section>
        ...
        <section 
          ...
          className={`py-20 px-4 ${isVisible['workshop'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-1000 ease-out`}
        >
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-10 text-[#E4CD15] inline-block relative">
            ...
            <div className="p-8 bg-[#38AAC9]/10 border-l-4 border-[#38AAC9] rounded-r-lg">
              <h3 className="text-2xl font-bold mb-6 text-[#E4CD15]">
                Great ideas are just the beginning. Scalability is what makes them legendary.
              </h3>
              
              <p className="mb-6">
                To prepare you for the hackathon, we're hosting an exclusive workshop on Building Scalable Tech by E-Dock. 
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <p>Understand how to scale your solutions for real-world applications.</p>
                </li>
                <li className="flex items-start">
                  <span className="text-[#E4CD15] text-2xl mr-2">•</span>
                  <p>Learn key business strategies that make a product investor-ready.</p>
                </li>
                <li className="flex items-start">
                  <span className="text-[#E4CD15] text-2xl mr-2">•</span>
                  <p>Master the fundamentals of tech-driven entrepreneurship.</p>
                </li>
              </ul>
              
              <p className="mt-6">
                Whether you're a solo innovator or part of a team, this workshop will give you a competitive edge 
        ...
        <section 
          ...
          className={`py-20 px-4 ${isVisible['guidelines'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-1000 ease-out`}
        >
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-10 text-[#E4CD15] inline-block relative">
              Guidelines
            ...
            <div className="p-6 bg-[#38AAC9]/10 border-l-4 border-[#38AAC9] rounded-r-lg">
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  <span className="text-[#E4CD15] text-2xl mr-2">•</span>
                  <p>Participants are required to stay on campus for the entire duration of the hackathon.</p>
                </li>
              </ul>
            </div>
          </div>
        ...
        <section 
          ...
          className={`py-20 px-4 ${isVisible['why-join'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-1000 ease-out`}
        >
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-10 text-[#E4CD15] inline-block relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-[#E4CD15]/10 p-6 rounded-lg border-l-4 border-[#E4CD15] transform transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-[#E4CD15]/20">
                <h3 className="text-xl font-bold mb-4 text-[#38AAC9]">Gain 5 Activity Points</h3>
                <p>Add valuable activity points to your academic record.</p>
              </div>
              
              <div className="bg-[#E4CD15]/10 p-6 rounded-lg border-l-4 border-[#E4CD15] transform transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-[#E4CD15]/20">
                <h3 className="text-xl font-bold mb-4 text-[#38AAC9]">Learn from the Best</h3>
                <p>Gain hands-on experience from industry experts.</p>
              </div>
              
              <div className="bg-[#E4CD15]/10 p-6 rounded-lg border-l-4 border-[#E4CD15] transform transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-[#E4CD15]/20">
                <h3 className="text-xl font-bold mb-4 text-[#38AAC9]">Think Beyond Coding</h3>
                <p>Develop business models & pitch ideas.</p>
              </div>
              
              <div className="bg-[#E4CD15]/10 p-6 rounded-lg border-l-4 border-[#E4CD15] transform transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-[#E4CD15]/20">
                <h3 className="text-xl font-bold mb-4 text-[#38AAC9]">Win Prizes & Recognition</h3>
                <p>Compete for cash prizes and awards.</p>
              </div>
              
              <div className="bg-[#E4CD15]/10 p-6 rounded-lg border-l-4 border-[#E4CD15] transform transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-[#E4CD15]/20">
                <h3 className="text-xl font-bold mb-4 text-[#38AAC9]">Networking</h3>
        ...
        <section 
          ...
          className={`py-20 px-4 ${isVisible['register'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-1000 ease-out`}
        >
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-16 text-[#E4CD15] inline-block relative">
              Registration & Fees
